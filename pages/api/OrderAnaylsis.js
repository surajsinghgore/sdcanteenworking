    ...
    try {
      ...
      if (req.body.year1 && req.body.year2 && req.body.year3) {
        async function SingleTotalOrder() {
          ...
          for (let i = 0; i < AllOrderData.length; i++) {
            let dateStr = AllOrderData[i].OrderDate.split(".");
            if (dateStr[2] == year2 && dateStr[1] == 1) {
              jan++;
            }

            if (dateStr[2] == year2 && dateStr[1] == 2) {
              feb++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 3) {
              mar++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 4) {
              apr++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 5) {
              may++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 6) {
              jun++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 7) {
              jul++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 8) {
              aug++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 9) {
              sep++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 10) {
              oct++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 11) {
              nov++;
            }
            if (dateStr[2] == year2 && dateStr[1] == 12) {
              dec++;
            }
          }
          total =
          ...
          totalOrderSum.push({ year: year2, total });
          ...
          for (let i = 0; i < AllOrderData.length; i++) {
            let dateStr = AllOrderData[i].OrderDate.split(".");
            if (dateStr[2] == year3 && dateStr[1] == 1) {
              jan++;
            }

            if (dateStr[2] == year3 && dateStr[1] == 2) {
              feb++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 3) {
              mar++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 4) {
              apr++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 5) {
              may++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 6) {
              jun++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 7) {
              jul++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 8) {
              aug++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 9) {
              sep++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 10) {
              oct++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 11) {
              nov++;
            }
            if (dateStr[2] == year3 && dateStr[1] == 12) {
              dec++;
            }
          }
          total =
          ...
          totalOrderSum.push({ year: year3, total });
        }
        ...
        async function SingleTotalCompleteOrder() {
          ...
          for (let i = 0; i < AllOrderData.length; i++) {
            ...
            if (
              dateStr[2] == year1 &&
              dateStr[1] == 1 &&
              AllOrderData[i].OrderStatus == "complete"
            ) {
              jan++;
            }
          ...
          totalOrderCompleteSum.push({ year: year2, total });
          ...
          totalOrderCompleteSum.push({ year: year3, total });
        }
        ...
        async function SingleTotalPendingOrder() {
          ...
          for (let i = 0; i < AllOrderData.length; i++) {
            ...
            if (
              dateStr[2] == year1 &&
              dateStr[1] == 1 &&
              AllOrderData[i].OrderStatus == "Pending"
            ) {
              jan++;
            }
          ...
          totalOrderPendingSum.push({ year: year2, total });
          ...
          totalOrderPendingSum.push({ year: year3, total });
        }
        ...
        async function SingleTotalRejectOrder() {
          ...
          for (let i = 0; i < AllOrderData.length; i++) {
            ...
            if (
              dateStr[2] == year1 &&
              dateStr[1] == 1 &&
              AllOrderData[i].OrderStatus == "reject"
            ) {
              jan++;
            }
          ...
          totalOrderRejectSum.push({ year: year2, total });
          ...
          totalOrderRejectSum.push({ year: year3, total });
        }
        ...
        return res.status(200).json({
            ...
            topFoodItem,
            topFoodItemMontWise,
            topCoffeeItemMontWise,
            topDrinkItemMontWise,
            topJuiceItemMontWise,
            allItemsTop,
        });
      }
        ...
        async function mostOrderedFood() {
          ...
          for (let j = 0; j < AllOrderData.length; j++) {
            ...
            if (
              date[2] == year1 &&
              date[1] == 1 &&
              AllOrderData[j].OrderStatus == "complete"
            ) {
              ja.push(AllOrderData[j]);
            }
            if (
              date[2] == year1 &&
              date[1] == 2 &&
          ...
          if (ja.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 1 });
          }
          ...
          if (fe.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 2 });
          }
          ...
          if (ma.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 3 });
          }
          ...
          if (ap.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 4 });
          }
          ...
          if (my.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 5 });
          }
          ...
          if (ju.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 6 });
          }
          ...
          if (jl.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 7 });
          }
          ...
          if (au.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 8 });
          }
          ...
          if (se.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 9 });
          }
          ...
          if (oc.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 10 });
          }
          ...
          if (no.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 11 });
          }
          ...
          if (de.length != 0) {
            ...
            food.push({ count: 0, Name: [no], year: year1, month: 12 });
          }
          ...
          if (ja.length != 0) {
            ...
            for (let i = 0; i < allCoffeeData.length; i++) {
              ...
              for (let j = 0; j < ja.length; j++) {
                for (let k = 0; k < ja[j].ItemsOrder.length; k++) {
                  if (
                    ja[j].ItemsOrder[k].ItemName == allCoffeeData[i].CoffeeName
                  ) {
                    count++;
                  }
                }
              ...
              temp.push({
                count: count,
                Name: [allCoffeeData[i].CoffeeName],
                year: year1,
                month: 1,
              });
            }
          ...
          if (ja.length != 0) {
            ...
            for (let i = 0; i < allJuiceData.length; i++) {
              ...
              for (let j = 0; j < ja.length; j++) {
                for (let k = 0; k < ja[j].ItemsOrder.length; k++) {
                  if (
                    ja[j].ItemsOrder[k].ItemName == allJuiceData[i].JuiceName
                  ) {
                    count++;
                  }
                }
          ...
          if (ja.length != 0) {
            ...
            for (let i = 0; i < allDrinkData.length; i++) {
              ...
              for (let j = 0; j < ja.length; j++) {
                for (let k = 0; k < ja[j].ItemsOrder.length; k++) {
                  if (
                    ja[j].ItemsOrder[k].ItemName == allDrinkData[i].DrinkName
                  ) {
                    count++;
                  }
                }
          ...
          for (let i = 0; i < newData.length; i++) {
            for (let j = 0; j < allFoodData.length; j++) {
              if (allFoodData[j]._id == newData[i].ProductId) {
                allItemsTop.push({
                  Name: allFoodData[j].FoodName,
                  Rate: newData[i].Rating,
                });
              }
            }
            ...
            for (let j = 0; j < allCoffeeData.length; j++) {
              if (allCoffeeData[j]._id == newData[i].ProductId) {
                allItemsTop.push({
                  Name: allCoffeeData[j].CoffeeName,
                  Rate: newData[i].Rating,
                });
              }
            }
