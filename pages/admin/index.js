...
const Admin = () => {
  ...
  const [allMonthWiseCollectionLen, setAllMonthWiseCollectionLen] =
    useState("0");
        ...
        <div className={anaylsis.allAnaylsis}>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              ...
              <span>Total: {allVisitorMonthWiseLen}</span>
            </h4>
            <div className={anaylsis.chart}>
              <MonthWiseLineChart
                montwisedata={allVisitorMonthWise}
                years={year}
                labels={`Visits In ${year}`}
              />
            </div>
          </div>
          {/* browser used */}
          <div className={anaylsis.charjs}>
            <h4>
              Browser Used To Access Sd Website In {year}{" "}
              <span>Total: {broswerDataLen}</span>
            </h4>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              ...
              <span>Total : {allOrderMonthWiseLen}</span>
            </h4>
            <div className={anaylsis.chart}>
              <MonthWiseBar
                browserData={allOrderMonthWise}
                labels={`Order Placed In Year ${year}`}
              />
            </div>
          </div>
          {/* top 10 trending */}
          ...
          <div className={anaylsis.charjs}>
            <h4>
              ...
              <span>Total ₹: {allMonthWiseCollectionLen}</span>
            </h4>
            <div className={anaylsis.chart}>
              <MonthWiseBar
                browserData={allMonthWiseCollection}
                labels={`Earning In Year ${year}`}
              />
            </div>
          </div>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              ...
              <span>Total: {allClientsDataLen}</span>
            </h4>
            <div className={anaylsis.chart}>
              <MonthWiseLineChart
                montwisedata={allClientsData}
                years={year}
                labels={`New User's In ${year}`}
              />
            </div>
          </div>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              Top 10 Most Ordered Food In {year} <span>Total: 10</span>
            </h4>
            <div className={anaylsis.chartPie}>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              Top 10 Most Ordered Coffee In {year} <span>Top 10</span>
            </h4>
            <div className={anaylsis.chartPie}>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              Top 10 Most Ordered Juice In {year} <span>Top 10</span>
            </h4>
            <div className={anaylsis.chartPie}>
          ...
          <div className={anaylsis.charjs}>
            <h4>
              Top 10 Most Ordered Drink In {year} <span>Top 10</span>
            </h4>
            <div className={anaylsis.chartPie}>
