                    ...
                    <div className={Style1.orders} key={item._id}>
                      ...
                      <div className={Style1.details}>
                        <div className={Style1.personal}>
                          ...
                          <div className={Style1.detailsInner}>
                        ...
                        <div className={Style1.orderRelated}>
                          <h3>Order Details:</h3>
                          <div className={Style1.detailsInner}>
                      ...
                      <div className={Style1.items}>
                        ...
                        <div className={Style1.ItemcardHeading}>
                          ...
                          <li className={Style1.size}>Item Size</li>
                              ...
                              return (
                                <div key={itx._id}>
                                  ...
                                  <div className={Style1.Itemcard}>
                                    <li className={Style1.foodName}>
                                      {" "}
                                      {itx.ItemName}
                                    </li>
                                    <li className={Style1.size}> {itx.Size}</li>
                                    <li className={Style1.price}>
                                      {" "}
                                      {itx.ProductOriginalAmount}
                                    </li>
                                    <li className={Style1.qty}>{itx.Qty}</li>
                                    <li className={Style1.rupee}>
                                      {" "}
                                      ₹{" "}
                                      {parseInt(itx.ProductOriginalAmount) *
                                        parseInt(itx.Qty)}
                                    </li>
                                  </div>
                                </div>
